...
run:
	qemu-system-aarch64 -M raspi3b -kernel $(KERNEL_IMG) -smp 4 -serial stdio -usb -device usb-net,netdev=net0 -netdev user,id=net0,hostfwd=udp::25565-:100,hostfwd=tcp:127.0.0.1:2222-:22,hostfwd=tcp:127.0.0.1:8080-:80 -device usb-mouse -device usb-kbd -drive file=sdcard_8MB.dd,if=sd,format=raw
